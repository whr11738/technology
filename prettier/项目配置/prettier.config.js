module.exports = {
  ...
  quoteProps: 'as-needed', // 对象中属性何时添加引号
  ...
  insertPragma: false, // 文件开头添加格式化的提醒
  proseWrap: 'preserve', // Markdown文本是否根据printWidth换行
  htmlWhitespaceSensitivity: 'css', //html存在空格是不敏感的
